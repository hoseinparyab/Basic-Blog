            ...
            <section class="col-md-10 pt-3">
                ...
                <section class="table-responsive">
                    <table class="table table-striped table-">
                        ...
                        <?php
                        global $pdo;
                        $query = "SELECT blog_php.posts .*, blog_php.categories.name AS category_name FROM  
                        blog_php.posts LEFT JOIN blog_php.categories ON blog_php.posts.cat_id = blog_php.categories.id";
